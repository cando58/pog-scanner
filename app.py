...
# -------------------------
art_no_input = st.text_input("Nhập MÃ HÀNG (ART_NO) để tìm:")
barcode_input = st.text_input("Nhập BARCODE (EAN_CODE) để tìm:")
...
if art_no_input:
    product = df_store[df_store['ART_NO'] == art_no_input.strip()]
elif barcode_input:
    product = df_store[df_store['EAN_CODE'] == barcode_input.strip()]
